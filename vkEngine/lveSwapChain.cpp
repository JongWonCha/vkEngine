...
LveSwapChain::LveSwapChain(LveDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<LveSwapChain> previous) : _device(deviceRef), _windowExtent(windowExtent), _oldSwapChain(previous)
{
    Init();
